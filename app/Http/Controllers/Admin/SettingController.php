...
class SettingController extends Controller {
    ...
    public function index(Request $request)
    {
        ...
        return $this->view('admin.setting.list');
    }
    ...
    public function show(Request $request, $id)
    {
        ...
        $this->_data = $setting;
        return !$request->offsetExists('of') ? $this->view('admin.setting.show') : $this->api($setting->toArray());
    }

    public function create()
    {
        $this->_data = [];
        $this->_validates = $this->censorScripts('setting.store', $this->keys);
        return $this->view('admin.setting.create');
    }

    public function store(Request $request)
    {
        $data = $this->censor($request, 'setting.store', $this->keys);
    ...
    public function edit($id)
    {
        ...
        $this->_validates = $this->censorScripts('setting.store', $this->keys);
        $this->_data = $setting;
        return $this->view('admin.setting.edit');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $data = $this->censor($request, 'setting.store', $this->keys, $setting);
