...
<div style="position:relative;top:0px;height:auto;margin-top:0px;" id="div1" align="center">
    <div style="position:absolute;top:0px;left:50%;width:100%;height:auto;margin-top:0px;margin-left:-50%;" align="center">
        <style>
            .userbut2 { display: inline-block; vertical-align: middle; width: 4.3rem; padding: 5px 0; border-radius: 35px; }
            .top_user { padding: 25px 3% 10px 3%; }
            .he1{ font-weight:700; }
            .cLi { box-shadow: 0px 1px 5px #efefef; }
            body{ background-color: #ffffff; }
            .ck { width: 50%; font-weight: 600; background: linear-gradient(90deg,rgba(255,219,73,1),rgba(255,204,9,1)); box-shadow: 0px 2px 5px 0px rgba(255,210,19,0.5); color: #020202; font-size: 14px; text-align: center; margin: 20px auto 0; border-radius: 20px; padding: 10px 0; }
            .cltxt1{ width: 95%; margin-left: 5px;font-size: 14px; color: #212121; text-align: center;}
            .cltxt1>span{ color: #ff3600; font-size: 16px; }
            .In_c_p4{ display: inline-block; vertical-align: middle; width: 44%; font-size: .5rem; text-align: left; margin-left: 5%; color: #222; }
            .In_c_p5{ display: inline-block; vertical-align: middle; font-size: .5rem; text-align: center; width: 46%; color: #222; }
            .In_c_p5 span{ color:#ff3600; } /*按钮选择*/
            .jtab{ width: 100%; margin-top: 10px; margin-bottom: 10px; }
            .jtabUl{ width: 95%; margin: 0 auto; font-size: 0; }
            .jtabLi{ display: inline-block; vertical-align: middle; width: 20%; text-align: center; }
            .jtabLi>img{ width: 60%; }
            .jtabLi>p{ width: 100%; font-size: 12px; margin-top: 5px; color: #212121; } /*兑换排行*/
            .ph{ width: 90%; }
            .ph1{ width: 100%; margin: 0 auto; text-align: left; font-size: 18px; font-weight: 900; color: #212121; }
            .phbox{ width: 100%; margin-top: 10px; font-size: 0; }
            .phLi{margin-right:5px; display: inline-block; vertical-align: top; width: 31%; position: relative; border-radius: 5px; overflow: hidden; }
            .phLi:nth-child(2){ margin: 10px 2%; } .phImg{ display: block; width: 100%; }
            .phImg1{ position: absolute; left: 0; top: 0; width: 30%; }
            .php1{ width: 95%; margin: 5px auto; font-size: 12px; color: #212121; overflow: hidden; white-space: nowrap; text-overflow: ellipsis; }
            .php2{ width: 95%; margin: 0 auto; font-size: 14px; color: #212121; }
            .php2>span{ color: #DD1818; }
            .php3{ width: 95%; margin: 0 auto; font-size: 14px; color: #212121; } /*猜你喜欢*/
            .cai{ width: 100%; }
            .cbox{ width: 94%; margin: 0 auto; }
            .cLi{ width: 48%; display: inline-block; vertical-align: middle; }
            .cLi:nth-child(odd){ margin-right: 1%; }
            .cLi:nth-child(even){ margin-left: 1%; }
            .climg{ width: 100%; }
            .dw_img { position: absolute; top: 0; left: 0; right: 0; bottom: 0; width: 50%; margin: auto; }
            .cltxt{ width: 95%; margin: 5px auto; font-size: 14px; color: #212121; overflow: hidden; white-space: nowrap; text-overflow: ellipsis; }
            .cai { width: 100%; } .I_txt { width: 90%; margin: 15px auto 10px; font-size: 0; }
            .I_t_h2 { float: left; width: 40%; font-size: 18px; font-weight: 900; color: #212121; text-align: left; }
            .I_txt_ul { float: right; width: 59%; white-space: normal; overflow: hidden; text-align: right; }
            .I_txt_ul li { display: inline-block; vertical-align: middle; }
            .I_txt_li1 { background-color: #999999; color: #fff; font-size: 0.5rem; padding: 1px 3px; border-radius: 50%; }
            .ph { padding: 10px 5%; width: 90%; background-color: #9bc5ff; }
            .middle_box { width: 100%; padding: 10px 0; }
            .gray_opcity{ position: relative; width: 100%; }
            .gray_opcity:after{ position: absolute; content: ''; background-color: rgba(185,185,185,0.5); display: block; width: 100%; height: 100%; top: 0px; }
        </style>
        <div class="content">
            <div class="top_box">
                ...
                <div class="top_user">
                    ...
                    <div style="font-size: 0.5rem;margin-top: 5px;">
                        <span style="color: gray;margin-right: 1rem;" class="jifenrule">更多优惠</span>积分可以兑换商品,过期清零,请尽快使用
                    </div>
                </div>
            </div>
